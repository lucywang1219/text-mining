...
def main():
    ...
    ## Draw a frequency plot that show the top 20 most common words in the whole text
    ...
    keywords = ['infrastructure', 'industrial', 'technology', 'ecosystems', 'environment', 'carbon', 'reform', 'energy', 'healthcare', 'agriculture']
    ...
    print(f'The similiarity ratio between {get_key(f1, dict)} and {get_key(f2, dict)} is {ratio}. \n') 
